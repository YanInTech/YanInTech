...
2. **[Finance Tracker 2.0](https://finance-tracker-ls0sl70hk-yanas-projects-f28389dc.vercel.app/)** – A personal finance tracker built around my own budgeting habits. It’s an improved version of my earlier tracker and a playground for learning React. While it’s still a work in progress (no database yet), I had a lot of fun building it and experimenting with features that actually fit how I manage my money.
3. **[Typing Test](https://typing-test-zeta-bay.vercel.app/)** – A fun little typing test I built spontaneously just to scratch that coding itch. Made it quickly with ChatGPT to pass the time, satisfy my curiosity, and relive a bit of the stress and excitement of building something new after finishing my capstone project.
